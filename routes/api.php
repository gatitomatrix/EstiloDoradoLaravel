...
Route::prefix('admin')->middleware(['auth:sanctum','abilities:admin'])->group(function () {
    ...
    Route::middleware(['role:ADMIN'])->group(function () {
        ...
        Route::get('reportes/ventas-dia.{ext}',  [ReporteAdminController::class, 'ventasDia'])->where('ext', 'xlsx|csv|pdf');
        Route::get('reportes/forma-pago.{ext}',  [ReporteAdminController::class, 'formaPago'])->where('ext', 'xlsx|csv|pdf');
        ...
        Route::get('asistente-interes.{ext}',    [AsistenteAdminController::class, 'interesExport'])->where('ext', 'xlsx|csv|pdf');
